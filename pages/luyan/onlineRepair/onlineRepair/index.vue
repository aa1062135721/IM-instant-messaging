<template>
	<view class="content">
		<u-navbar title="在线报修" :background="bageVal" :borderBottom="false" :backIconColor='titleColor' :titleColor='titleColor'></u-navbar>
		<view class="top">
			<image src="../../../../static/luyan/images/icon_onlineRepair_top_bg.png" mode="aspectFit"></image>
		</view>
		<view class="main">
			<view class="menu">
				<view class="menuItem" @tap="goRepair('0')">
					<image src="../../../../static/luyan/images/icon_onlineRepair_public.png" mode="aspectFit"></image>
					<view class="">房屋报修</view>
				</view>
				<view class="menuItem" @tap="goRepair('1')">
					<image src="../../../../static/luyan/images/icon_onlineRepair_personal.png" mode="aspectFit"></image>
					<view class="">家电报修</view>
				</view>
			</view>
			<view class="listBox">
	...
	export default {
		...
		methods: {
			...
			getList(){
				...
				this.$api.to_http('reportrepair/page', {
					type:'',
					pageNo:this.pageNo,
			...
			goRepair(i) {
				uni.navigateTo({
					url:'/pages/luyan/onlineRepair/addRepair/index?type=' + i
				})
			},
			// 报修详情
			goDetail(i){
				uni.navigateTo({
					url:'/pages/luyan/onlineRepair/repairDetail/index?id='+i+"&type=1"
				})
			}
		},
	}
